// lib/features/academic_affairs/presentation/screens/academic_affairs_profile_screen.dart
...
class HeadOfDepartmentProfileScreen extends StatelessWidget {
  final User user;
  const HeadOfDepartmentProfileScreen({super.key, required this.user});
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      const CircleAvatar(
                        radius: 50,
                        child: Icon(Icons.book_rounded, size: 50),
                      ),
